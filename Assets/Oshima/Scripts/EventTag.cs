...
{//　ログシステム
    ...
    private void OnCollisionEnter(Collision collision)
    {
		...
		{
			logSystem.AddLogText("<color=green>" + collision.gameObject.GetComponent<PlayerInfomation>().EnemyName + "</color>" + "が<color=blue>" + areaName + "</color>" + "に接触しました。", LogInfomation.LogType.Event);
		}
